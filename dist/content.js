...
window.JINCHUAN_CONTENT = {
  ...
  "notes": [
    {
      "id": "start-small",
      "category": "学习方法 / START HERE",
      "title": "学 AI，从解决一个小问题开始",
      "summary": "不急着收集工具，先完成一件具体的事。",
      "tags": [
        "AI",
        "学习"
      ],
      ...
      "steps": [
        ...
        [
          "说清楚你要什么。",
          "给出背景、材料、期望格式，以及一个好结果的例子。"
        ],
        [
          "亲自检查结果。",
          "核对事实和来源，留下有效的方法，也记下失败的原因。"
        ]
      ]
    },
    {
      "id": "clear-requests",
      "category": "提示词 / PROMPTING",
      "title": "把需求说清楚，比“神奇提示词”更重要",
      "summary": "背景、目标、限制、输出：一个简单的表达框架。",
      "tags": [
        "AI",
        "方法"
      ],
    ...
    {
      "id": "first-project",
      "category": "动手实践 / BUILD SOMETHING",
      "title": "给你的第一个 AI 小作品，定一个终点",
      "summary": "先做一个能用的版本，再让它慢慢长大。",
      "tags": [
        "实践",
        "产品"
      ],
  ...
  "socialLinks": [
    {
      "platform": "github",
      "label": "GitHub",
      "value": "sunmillionai-2001",
      "url": "https://github.com/sunmillionai-2001"
    }
  ]
};
