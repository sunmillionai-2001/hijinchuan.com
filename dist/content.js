...
window.JINCHUAN_CONTENT = {
  ...
  updates: [
    // 以下记录仅用于预览滚动效果，均非真实动态；确认效果后可删除。
    {
      date: '2026-09-24',
      text: '【演示】整理了一个新想法的页面草图，先把问题和最小可用版本写清楚。',
      tags: ['演示数据']
    },
    {
      date: '2026-09-23',
    ...
    {
      date: '2026-09-22',
      text: '【演示】把一次 AI 工作流实验记成短笔记，准备继续验证是否真的节省时间。',
      tags: ['演示数据']
    },
    {
      date: '2026-09-20',
      text: '【演示】调整产品介绍，让第一次来的访客更快看懂它能解决什么问题。',
      tags: ['演示数据']
    },
    {
      date: '2026-09-17',
      text: '【演示】给一个小工具补上使用说明和反馈入口。',
      tags: ['演示数据']
    },
    {
      date: '2026-09-14',
      text: '【演示】回看上周的尝试，删掉一个不必要的功能。',
      tags: ['演示数据']
    }
  ],
  socialLinks: [
